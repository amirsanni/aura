...
class Genmod extends CI_Model{
    ...
    */
    ...
    /**
     * Save messages sent to us via the contact us page to the db
     * @param type $name
     * @param type $email
     * @param type $subject
     * @param type $phone
     * @param type $msg
     */
    public function log_message($name, $email, $subject, $phone, $msg){
        $q = "INSERT INTO messages (name, email, subject, phone, msg) VALUES (?, ?, ?, ?, ?)";
        
        $this->db->query($q, [$name, $email, $subject, $phone, $msg]);
