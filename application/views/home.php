...
?>
    <head>
        ...
        <link rel="stylesheet" href="<?=base_url()?>public/css/supersized.shutter.css" type="text/css" media="screen" />
        ...
        <script type="text/javascript" src="<?=base_url()?>public/js/supersized.shutter.min.js"></script>
...
<body>
    ...
    <div id="controls-wrapper" class="load-item">
        <div id="controls">
            ...
            <a id="play-button"><img id="pauseplay" src="<?=base_url()?>public/images/hslideimg/pause.png"/></a>
            ...
            <!--Thumb Tray button-->
            <a id="tray-button"><img id="tray-arrow" src="<?=base_url()?>public/images/hslideimg/button-tray-up.png"/></a>
